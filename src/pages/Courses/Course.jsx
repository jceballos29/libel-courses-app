...
const Course = () => {
  ...
  const { currentCourse: course, loading } = useSelector((state) => state.course);
  ...
  return !loading ? (
        ...
        <div className='container flex py-16'>
          <div className='w-full xl:w-2/3'>
            <header>
              ...
              <div className='w-full flex flex-col space-y-2 lg:space-y-0 lg:flex-row lg:items-center lg:space-x-3 mb-2 text-sm'>
                <div className='flex items-center'>
                  ...
                  <span className='text-[#4F547B] ml-2'>
                    ({course.reviews.length} calificaciones)
                  </span>
                </div>
                ...
                <p className='hidden text-[#4F547B] xl:flex items-center'>
                  ...
                  </strong>{' '}
                  {
                    [
                      ...
                      'Noviembre',
                      'Diciembre',
                    ][new Date(course.updatedAt).getMonth() - 1]
                  }
              ...
              <div className='text-[#4F547B] flex items-center mb-2'>
                ...
                <Link
                  to={`${path.instructors}/${course.instructor.username}`}
                  className='hover:underline hover:text-[#6440FB]'>
            ...
            <div className='w-full mt-16 lg:py-8 lg:px-6 lg:bg-white rounded-lg lg:shadow-lg'>
              <div>
                ...
                <div className='text-[#4F547B] lg:pl-6'>
          ...
          <div className='hidden w-full lg:w-1/3 xl:flex items-start justify-center'>
            <div className='sticky top-20 w-80 p-3 rounded-lg shadow-lg bg-white space-y-3'>
              ...
              <button className='w-full py-3 rounded border font-medium text-sm bg-[#6440FB] border-[#6440FB] text-white hover:text-[#6440FB] hover:bg-transparent outline-none focus:outline-none duration-200'>
                Comprar Ahora
              </button>
    ...
    <div className='mt-16 py-48 flex items-center justify-center'>
      <div className='flex items-center'>
